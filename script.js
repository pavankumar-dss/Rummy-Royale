// --- DOM Elements ---
        ...
        function renderPlayerHand() {
            ...
            player.hand.forEach(card => {
                ...
                // FIX: Re-added drag and drop listeners to individual cards
        ...
        // FIX: Re-implemented a robust drag and drop system
        ...
        ungroupedCardsContainer.addEventListener('drop', () => {
            ...
            const newHandOrder = Array.from(ungroupedCardsContainer.children).map(el => {
                return player.hand.find(c => c.suit === el.dataset.suit && c.value === el.dataset.value) 
                       || { suit: el.dataset.suit, value: el.dataset.value }; // Find existing or create new object
            });
